...
step2d_cells = [[1,2,3,4]];
step2d = MKPOL([step2d_points, step2d_cells, None]);
step2d1 = MKPOL([step2d_points1, step2d_cells, None]);
step2d_extruded = PROD([step2d, Q(1.2)]);
step2d_extruded1 = PROD([step2d1, Q(1.2)]);
...
building = STRUCT([pillars0, pillars1, pillars2, pillars3, floors0, floors1, floors2, floors3, floors4, east, west, south, windowsFrames, stairs1, stairs2, stairs3 ]);
